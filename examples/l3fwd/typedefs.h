/**************************************************************
*
* Instructions: the file of typedefs.h used to declear some types
*	which are used in the CIP stack
*
* Creating Date: 2020-4-17
* Author: 
*
***************************************************************/
...
/*! If the stack used in DPDK , we should shut down this define . */
#ifndef DPDK_SUPPORT
